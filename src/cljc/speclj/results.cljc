...
(defn pass? [result] (instance? PassResult result))
(defn fail? [result] (instance? FailResult result))
(defn pending? [result] (instance? PendingResult result))
(defn error? [result] (instance? ErrorResult result))
